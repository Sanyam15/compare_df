...
#print(UniqueRecords.getUniqueRecords(df1,df2))
print(VariableRecords.getVariableRecords(df1,df2,key=list(df1.columns)[0:2],metrics=list(df1.columns)[2:],unique=True))